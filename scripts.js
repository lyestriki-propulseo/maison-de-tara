...
(function () {
  ...
  const heroTabs = (() => {
    ...
    const variants = {
      atelier: {
        title: 'La maison où l\'on <em>prend le temps</em>.',
        lead: 'Un lieu hybride entre atelier de peinture sur céramique, café et maison de décoration d\'inspiration indienne — pensé comme une maison vivante.'
      },
      cafe: {
        title: 'S\'attabler. <em>Sans réserver</em>.',
        lead: 'Café spécialité, thés rares, pâtisseries du jour et charcuterie artisanale. Le café vit en parallèle de l\'atelier — pensé comme une cuisine ouverte.'
      },
      boutique: {
        title: 'Une boutique <em>aux pièces choisies</em>.',
        lead: 'Textiles brodés, lampes en céramique, objets de décoration indienne. Une sélection confidentielle, renouvelée chaque saison.'
      }
    };
